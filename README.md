...
- [thorough-pytorch](https://github.com/datawhalechina/thorough-pytorch)-**Star 1.3K**: A chinese tutorial of PyTorch.
- [Chat甄嬛](https://github.com/KMnO4-zx/huanhuan-chat)-**Star 122**: A chat robot based on ChatGLM2 likes Zhenhuan.
- [动手学深度学习习题解答](https://github.com/datawhalechina/d2l-ai-solutions-manual)-**Star 102**: A Chinese exercise solution project for the "Dive into Deep Learning".
